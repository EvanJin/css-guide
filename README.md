 ...
 * 2-3. 当前使用的CSS库（持续更新）
   * util-01 通用导航条 /style/nav.css
   * util-02 通用footer /style/footer.css
   * ui-01. Confirmbxo  /style/ui/Confirmbox.css
   * ui-02. widget(包括登陆框样式) /style/widget.css
 ...
 * 3-1.
 * 通用的CSS文件，放在如下目录中：(地址http://is.kuaibo.com/sq/style/common)
<table width="300" style="margin-left:60px;">
<tbody><tr><td> 基本样式库 </td><td style="text-align: left"> /style/global, /style/common
</td></tr><tr><td> JS组件相关样式库 </td><td style="text-align: left"> /style/ui
</td></tr></tbody></table>

 * 3-2. 业务类的CSS是指和具体产品相关的文件，放在如下目录中：
<table width="200" style="margin-left:60px;">
<tbody><tr><td> 首页 </td><td style="text-align: left"> /style/passport/ 
</td></tr><tr><td> 雷达 </td><td style="text-align: left"> /style/radar/ 
</td></tr><tr><td> 私有云 </td><td style="text-align: left"> /style/webcloud/ 
